    ...
    <div class="py-4 overflow-y-auto">
        <ul class="space-y-2 mt-6 font-medium">
          ...
          <li>
            <a href="{{ route ('admin.recruit.home') }}" class="text-black dark:text-blue-200 hover:text-blue-700"  >
              RECRUITMENT MODULE 
            </a>
          </li>
          ...
          <li>
            <button
              type="button"
              class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              aria-controls="dropdown-questionnaires"
              data-collapse-toggle="dropdown-questionnaires"
            >
