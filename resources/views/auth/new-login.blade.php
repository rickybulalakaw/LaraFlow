            ...
            <div class="grid items-center w-full max-w-6xl gap-10 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-0 text-sm text-white">
                        by <a href="https://graceit.ph">
                            GraceIT Software Development Services
                        </a>
                    </p>

                    <p class="mt-6 text-sm text-white">Don't have an account <a href="{{ route('register') }}"
                            class="ml-1 font-semibold text-white underline">Register here</a></p>
                </div>

                <form method="POST" action="{{ route('login') }}"
                    class="w-full max-w-md px-6 py-8 space-y-6 bg-white rounded-xl md:ml-auto">
                    @csrf
                    <h3 class="mb-12 text-3xl font-extrabold">
                        Sign in
                    </h3>

                    <div>
                        <input name="email" autofocus type="email" autocomplete="email" required
                    ...
                    <p class="my-6 text-sm text-center text-gray-400">or continue with</p>
